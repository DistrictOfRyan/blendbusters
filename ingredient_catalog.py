...
CATALOG = {
    ...
    # batch 2026-07-19 (grocery / specialty; verified via Amazon result URL + title)
    'coffee':        ('B09HCSNLQZ', 'Folgers Classic Roast Ground Coffee'),
    'sparklingwater':('B0B1KCM85Y', 'LaCroix Sparkling Water Variety Pack'),
    'magmalate':     ('B09SK94649', 'Nutricost Magnesium Malate'),
    'magcitrate':    ('B004189JCW', 'NOW Magnesium Citrate Powder'),
    'potassium':     ('B004EPBMRC', 'Nu-Salt Salt Substitute (potassium chloride)'),
    'resistantstarch':('B078TQ6GBW', "Bob's Red Mill Potato Starch"),
    'flavor':        ('B003YP3MUS', 'True Lemon Water Enhancer'),
    'salt':          ('B000Q3CJGO', 'Morton Iodized Salt'),
    'cacao':         ('B00EFE7R8K', 'Terrasoul Organic Cacao Powder'),
    'horsetail':     ('B00028M04Y', 'NOW Silica Complex with Horsetail'),
    'morosil':       ('B0CRCMJF53', 'Morosil Red Orange Extract 400 mg'),
    'blackcurrant':  ('B00A8PJC4C', 'NOW Black Currant Oil 1000 mg'),
    'ceramides':     ('B00EEOGIWC', 'Sports Research Phytoceramides'),
    'pumpkinseed':   ('B000A2G2U0', 'NOW Pumpkin Seed Oil 1000 mg'),
    'ghee':          ('B00VXQGY28', '4th & Heart Grass-Fed Ghee'),
    'immune':        ('B08NKKVK5Q', "Nature's Bounty Vitamin C 24-Hr + Zinc + D"),
}
...
RULES = [
    ...
    (r'magnesium malate', 'magmalate'),
    (r'magnesium citrate', 'magcitrate'),
    ...
    # grocery / specialty (batch 2026-07-19)
    (r'potassium|lite salt|nu-?salt|salt substitute', 'potassium'),
    (r'\bsalt\b|sodium chloride', 'salt'),
    (r'\bcoffee\b|espresso|nescaf', 'coffee'),
    (r'sparkling water|seltzer|carbonated water', 'sparklingwater'),
    (r'flavor|drink mix|water enhancer|citrus.*mix', 'flavor'),
    (r'cacao|cocoa powder', 'cacao'),
    (r'resistant starch|potato starch|green banana|tapioca starch', 'resistantstarch'),
    (r'horsetail|\bsilica\b', 'horsetail'),
    (r'morosil|red orange|moro ', 'morosil'),
    (r'black currant', 'blackcurrant'),
    (r'ceramide|phytoceramide', 'ceramides'),
    (r'pumpkin seed', 'pumpkinseed'),
    (r'full[\s-]?fat dairy|\bghee\b|\bc15\b|pentadecanoic', 'ghee'),
    (r'immune', 'immune'),
    # similar-product maps (William OK'd): send these to the closest verified item
    (r'eriomin|eriocitrin|lemon flavonoid', 'quercetin'),
    (r'fruit.*(veggie|vegetable)|fruits? (and|&|\+) (veg|veggie|vegetable)', 'greens'),
    (r'clear.*fiber|natural fiber|wheat dextrin|prebiotic fiber|\bfiber\b', 'inulin'),
